...
# Script de déploiement automatique complet pour Scaleway
# Usage: ./deploy-auto.sh

set -e

echo "🚀 Déploiement Automatique WeBoost sur Scaleway"
echo "================================================"
...
info "Étape 5: Déploiement sur le serveur..."
...
info "1. cd /var/www/weboost"
info "2. pm2 start ecosystem.config.js"
info "3. pm2 save"
info ""
